...
import com.bll.lnkcommon.ui.activity.teaching.ExamDetailsActivity
import com.bll.lnkcommon.ui.adapter.teaching.StudentExamAdapter
import com.bll.lnkcommon.utils.DP2PX
import com.bll.lnkcommon.utils.NetworkUtil
import com.bll.lnkcommon.widget.SpaceItemDeco
import kotlinx.android.synthetic.main.fragment_list_content.*

class StudentExamFragment : BaseFragment(),IExamView {
    private val presenter=ExamPresenter(this)
    private var exams = mutableListOf<ExamList.ExamBean>()
    private var mAdapter: StudentExamAdapter? = null
    ...
    private fun initRecyclerView() {
        ...
        mAdapter = StudentExamAdapter(R.layout.item_homework_teacher, null)
